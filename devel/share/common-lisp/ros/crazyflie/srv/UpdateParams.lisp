...
(cl:defmethod cl:initialize-instance :after ((m <UpdateParams-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateParams-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-srv:<UpdateParams-request> is deprecated: use crazyflie-srv:UpdateParams-request instead.")))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <UpdateParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:params-val is deprecated.  Use crazyflie-srv:params instead.")
  (params m))
...
(cl:defmethod cl:initialize-instance :after ((m <UpdateParams-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateParams-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-srv:<UpdateParams-response> is deprecated: use crazyflie-srv:UpdateParams-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateParams-response>)))
  ...
  "crazyflie/UpdateParamsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateParams-response)))
  "Returns string type for a service object of type 'UpdateParams-response"
  "crazyflie/UpdateParamsResponse")
