...
(cl:defmethod cl:initialize-instance :after ((m <AddCrazyflie-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddCrazyflie-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-srv:<AddCrazyflie-request> is deprecated: use crazyflie-srv:AddCrazyflie-request instead.")))

(cl:ensure-generic-function 'uri-val :lambda-list '(m))
(cl:defmethod uri-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:uri-val is deprecated.  Use crazyflie-srv:uri instead.")
  (uri m))

(cl:ensure-generic-function 'tf_prefix-val :lambda-list '(m))
(cl:defmethod tf_prefix-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:tf_prefix-val is deprecated.  Use crazyflie-srv:tf_prefix instead.")
  (tf_prefix m))

(cl:ensure-generic-function 'roll_trim-val :lambda-list '(m))
(cl:defmethod roll_trim-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:roll_trim-val is deprecated.  Use crazyflie-srv:roll_trim instead.")
  (roll_trim m))

(cl:ensure-generic-function 'pitch_trim-val :lambda-list '(m))
(cl:defmethod pitch_trim-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:pitch_trim-val is deprecated.  Use crazyflie-srv:pitch_trim instead.")
  (pitch_trim m))

(cl:ensure-generic-function 'enable_logging-val :lambda-list '(m))
(cl:defmethod enable_logging-val ((m <AddCrazyflie-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-srv:enable_logging-val is deprecated.  Use crazyflie-srv:enable_logging instead.")
  (enable_logging m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddCrazyflie-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddCrazyflie-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-srv:<AddCrazyflie-response> is deprecated: use crazyflie-srv:AddCrazyflie-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddCrazyflie-response>)))
  ...
  "crazyflie/AddCrazyflieResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddCrazyflie-response)))
  "Returns string type for a service object of type 'AddCrazyflie-response"
  "crazyflie/AddCrazyflieResponse")
