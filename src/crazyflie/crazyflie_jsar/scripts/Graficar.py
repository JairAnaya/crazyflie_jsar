...
class DataRecorder:
    def __init__(self):
        ...
        self.suffix2 = ''
        if self.ros_param2 == 1:
            self.suffix2 = 'PID'
        elif self.ros_param2 == 2:
            self.suffix2 = 'Mellinger'
        elif self.ros_param2 == 3:
            self.suffix2 = 'INDI'
        elif self.ros_param2 == 4:
            self.suffix2 = 'Brescanccini'
        elif self.ros_param2 == 5:
            self.suffix2 = 'Lee'
