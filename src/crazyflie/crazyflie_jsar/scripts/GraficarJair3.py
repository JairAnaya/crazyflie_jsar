...
class DataRecorder:
    def __init__(self):
        ...
        self.ros_param3 = rospy.get_param('~n3', 0)
        ...
        if self.ros_param2 == 5:
            ...
            self.suffix2 = 'PID'
        elif self.ros_param2 == 12:
            self.suffix2 = 'MIX'
        
        self.suffix3 = ''
        if self.ros_param3 == 5:
            self.suffix3 = 'SMC'
        elif self.ros_param3 == 6:
            self.suffix3 = 'BC'
        elif self.ros_param3 == 7:
            self.suffix3 = 'TC'
        elif self.ros_param3 == 8:
            self.suffix3 = 'STA'
        elif self.ros_param3 == 9:
            self.suffix3 = 'NTSMC'
        elif self.ros_param3 == 10:
            self.suffix3 = 'STSMC'
        elif self.ros_param3 == 11:
            self.suffix3 = 'PID'
        elif self.ros_param3 == 12:
            self.suffix3 = 'MIX'


        self.base_name_1 = "Agente1_" + self.suffix1
        self.base_name_2 = "Agente2_" + self.suffix2
        self.base_name_3 = "Agente3_" + self.suffix3
        ...
        rospy.Subscriber('/crazyflie3/sc', Twist, self.CMD_Signals3)
        rospy.Subscriber('/vrpn_client_node/crazyflie3/pose', PoseStamped, self.VRPNPOSE3)
    ...
    def CMD_Signals3(self, msg):
        self.tau_phi3 = msg.linear.x
        self.tau_theta3 = msg.linear.y
        self.tau_psi3 = msg.linear.z
        self.u3 = msg.linear.z

    def VRPNPOSE3(self, msg):
        q = msg.pose.orientation
        rpy = t.euler_from_quaternion([q.x, q.y, q.z, q.w])
        self.psi3 = rpy[2]
        self.x3 = msg.pose.position.x
        self.y3 = msg.pose.position.y
        self.z3 = msg.pose.position.z
    ...
    def Start(self, msg):
        ...
        if self.is_saving_data:
            self.Quad3.append([self.x3, self.y3, self.z3, self.psi3, self.u3, self.tau_phi3, self.tau_theta3, self.tau_psi3])
    ...
    def save_data(self):
        home_dir = os.path.expanduser("~/ExpLemnis14_05")
        ...
        mat_path_quad3 = os.path.join(home_dir, self.base_name_3 + ".mat")

        data_dict_quad3 = {'Quad3_data': self.Quad3}
        io.savemat(mat_path_quad3, data_dict_quad3)
